...
| 软件                                                         |    版本     | 说明                                                         |
| ------------------------------------------------------------ | :---------: | ------------------------------------------------------------ |
| [FastGestures](https://fg.zhaokeli.com/#doc) [github](https://github.com/zhaokeli/FastGestures/releases/latest) |   2.2.43    | 全局鼠标手势,仅windows                                       |
...
| [PowerToys](https://github.com/microsoft/PowerToys/releases/latest) [功能介绍](https://learn.microsoft.com/zh-cn/windows/powertoys/video-conference-mute) github |   0.89.0    | 微软官方工具集                                               |
...
| [eSearch](https://github.com/xushengfeng/eSearch/releases/latest) **跨平台** github |   14.6.1    | 屏幕搜索功能，当然也是一款方便的截屏软件                     |
...
| 软件                                                      |  版本   | 说明             |
| --------------------------------------------------------- | :-----: | ------------------ |
| [IDM](http://www.internetdownloadmanager.com/news.html)  [cracker](https://leon.lanzoue.com/iy5Vl20zosza) 🔄 | 6.42.31 | 下载工具 |
...
| [FDM](https://www.freedownloadmanager.org/zh/download.htm) 跨平台 | 6.26.1 | 免费下载工具 |
| [Neat Download Manager](https://www.neatdownloadmanager.com/index.php/en/) Win + Mac | 1.4 | 免费下载工具，文件小 |
| [AB Download Manager](https://abdownloadmanager.com/) Win + Linux [github](https://github.com/amir1376/ab-download-manager/releases) | 1.5.4 | 开源下载工具 kotlin compose |
|  |  |  |
...
| [reqable 发布](https://github.com/reqable/reqable-app)  **跨平台 📱** | 2.33.7 | 抓包工具，Android小黄鸟作者 |
| [WiresharkPortable](https://www.wireshark.org/download.html) **跨平台** |     4.4.5     | 抓包工具             |
...
| [Burp Suite](https://portswigger.net/burp/releases)  [汉化](https://github.com/Leon406/BurpSuiteCN-Release) **跨平台** | 2025.2.3 | 渗透 2023.1.2/2023.2.2版本开始不支持win10以下 |
|                                                              |          |                                               |
...
| [clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev/releases/latest) github | 2.2.2 | |
| [v2rayN](https://github.com/2dust/v2rayN/releases) github<br>[v2ray-core](https://github.com/v2fly/v2ray-core/releases) github |  7.10.5<br>5.29.3  | v2ray ss工具<br>v2ray core |
...
| [GithubDesktop](https://desktop.github.com/release-notes/)  [汉化](https://pan.lanzoub.com/b06mtfjkh) |  3.4.18  | github 桌面端                         |
...
| [XnView MP](https://www.xnview.com/en/xnviewmp/)  **跨平台**    |         1.8.7         | 图片查看        |
...
| [edge ](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      134.0.3124.95      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      135.0.7049.41      | 浏览器          |
...
| [ventoy](https://github.com/ventoy/Ventoy/releases)   |   1.1.05   | 系统启动盘 |
|                                                       |            |            |
...
| [FFmpeg Batch AV Converter](https://sourceforge.net/projects/ffmpeg-batch/files/latest/download) |  3.2.2   | 音视频批量多线程转换 |
...
| [FontViewOk](http://www.softwareok.com/?seite=Freeware/FontViewOK/Autoupdate) |  8.61   | 字体预览                          |
| [softCnKiller](https://www.lanzoub.com/b0cpu1guf)            |  2.82   | 流氓软件检测                      |
| [直播Simple Live](https://github.com/xiaoyaocz/dart_simple_live/releases)  **跨平台**📱Flutter |  1.7.6  | 斗鱼、虎牙、b站、抖音直播平台聚合 |
...
| 软件                                                         |                      版本                       | 说明                                      |
| ------------------------------------------------------------ | :---------------------------------------------: | ----------------------------------------- |
| .[NET 10](https://dotnet.microsoft.com/zh-cn/download/dotnet/10.0)<br/>[.NET8 (LTS 2026/11)](https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0) <br><del>[.NET6 (LTS 2024/11)](https://dotnet.microsoft.com/zh-cn/download/dotnet/6.0)</del> |                8.0.13<br/>6.0.36                |                                           |
...
| [python](https://www.python.org/downloads/)<br/>[anaconda](https://www.anaconda.com/download/success)<br>minicoda (非 ai大数据方向推荐，＜70 pkgs, ＜500 M) | 3.9.21 3.13.2<br/>2022.10 (3.9.13)<br>2024.10-1 | 建议3.9版本,3.10+第三方库可能存在兼容问题 |
| [git](https://git-scm.com/)                                  |                     2.49.0                      |                                           |
| [nodejs](https://nodejs.org/en)                              |                   22.14.0 LTS                   |                                           |
|                                                              |                                                 |                                           |
