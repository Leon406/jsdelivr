...
| 软件                                                         |    版本     | 说明                        |
| ------------------------------------------------------------ | :---------: | --------------------------- |
| [FastGestures](https://fg.zhaokeli.com/#doc) [github](https://github.com/zhaokeli/FastGestures) |    2.2.8    | 全局鼠标手势,仅windows      |
...
| [chatall](https://github.com/sunner/ChatALL/releases/latest)  github**跨平台** |   1.63.97   | 需要自有账号                |
...
| [obsidian](https://obsidian.md/) [github](https://github.com/obsidianmd/obsidian-releases) |   1.5.11    | 笔记软件,需自行选用同步软件 |
|                                                              |             |                             |
...
| [xdown](https://xdown.org) 自动更新                       | 2.0.8.3 | 下载工具  自动升级 |
...
| [Burp Suite](https://portswigger.net/burp/releases)  [汉化](https://github.com/Leon406/BurpSuiteCN-Release) **跨平台** | 2024.2.1 | 渗透 2023.1.2/2023.2.2版本开始不支持win10以下 |
|                                                              |          |                                               |
...
| 软件                                                         |  版本  | 说明        |
| ------------------------------------------------------------ | :----: | ------------- |
| [Telegram](https://github.com/telegramdesktop/tdesktop/releases)  自动更新 **跨平台** | 4.15.6 | 聊天          |
...
| [v2rayN](https://github.com/2dust/v2rayN/releases) github    |  6.39  | v2ray ss工具  |
| [v2ray](https://github.com/v2fly/v2ray-core/releases) github | 5.15.1 | v2ray工具     |
| **[stairspeedtest-reborn](https://github.com/tindy2013/stairspeedtest-reborn/actions)** github | 0.7.2 | 节点测速 |
| [steamcommunity](https://www.dogfight360.com/blog/686/) | 12.1.36 | 反代steam, github等 |
...
| [VSCode](https://github.com/microsoft/vscode) github         | 1.87.2 | 编辑器                                |
| [Notepad++](https://notepad-plus-plus.org/downloads/)  [github](https://github.com/notepad-plus-plus/notepad-plus-plus) | 8.6.4 | 文本编辑 |
| [EmEditor ](https://www.emeditor.com/download/) | 24.1.0 | 编辑器 支持大文件 |
| [ApiFox](https://www.apifox.cn/help/app/changelog/)  [在线版](https://www.apifox.cn/web) **跨平台** :star: | 2.5.15 | 接口测试 |
| [ApiPost](https://www.apipost.cn/download.html) [在线版](https://console.apipost.cn/apis/project) **跨平台** |  7.2.6  | 接口测试                              |
| [GithubDesktop](https://desktop.github.com/release-notes/)  [汉化](https://pan.lanzoub.com/b06mtfjkh) |  3.3.12  | github 桌面端                         |
...
| [edge ](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      123.0.2420.65      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      123.0.6312.86      | 浏览器          |
...
| [Qalcualte](https://github.com/Qalculate/qalculate-gtk) github | 5.0 | 科学计算器 |
|                                                              |               |                  |
|  |  |  |
...
| 软件                                                         |   版本   | 说明                 |
| ------------------------------------------------------------ | :------: | -------------------- |
| [xnconvert](https://www.xnview.com/en/xnconvert/#downloads)  | 1.100.1  | 图片格式转换汉化工具 |
...
| ------------------------------------------------------------ | :----------------------------------------------: | ----------------------------------------- |
| [.NET6 (LTS)](https://dotnet.microsoft.com/zh-cn/download/dotnet/6.0) <br>[.NET8 (LTS)](https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0) |                 6.0.28<br/>8.0.3                 |                                           |
...
| [python](https://www.python.org/downloads/)<br/>[anaconda](https://www.anaconda.com/products/distribution) | 3.9.19  3.12.2<br/>2022.10 (3.9.13)<br>2024.02-1 | 建议3.9版本,3.10+第三方库可能存在兼容问题 |
| [git](https://git-scm.com/)                                  |                      2.44.0                      |                                           |
| [nodejs](https://nodejs.org/en)                              |                   20.12.0 LTS                    |                                           |
