...
| 软件                                                         |    版本     | 说明                                                         |
| ------------------------------------------------------------ | :---------: | ------------------------------------------------------------ |
| [FastGestures](https://fg.zhaokeli.com/#doc) [github](https://github.com/zhaokeli/FastGestures/releases/latest) |   2.2.36    | 全局鼠标手势,仅windows                                       |
| [CopyQ](https://github.com/hluk/CopyQ/releases/latest) github **跨平台** |    9.1.0    | 剪切板管理工具                                               |
...
| [PowerToys](https://github.com/microsoft/PowerToys/releases/latest) [功能介绍](https://learn.microsoft.com/zh-cn/windows/powertoys/video-conference-mute) github |   0.87.1    | 微软官方工具集                                               |
| [obsidian](https://obsidian.md/) [github](https://github.com/obsidianmd/obsidian-releases/releases/latest) |    1.7.7    | 笔记软件,需自行选用同步软件                                  |
...
| [eSearch](https://github.com/xushengfeng/eSearch/releases/latest) **跨平台** github |   14.3.0    | 屏幕搜索功能，当然也是一款方便的截屏软件                     |
| [localsend](https://github.com/localsend/localsend/releases/latest)  **跨平台📱** github |   1.16.1    | 文件传输                                                     |
|                                                              |             |                                                              |
...
| [reqable 发布](https://github.com/reqable/reqable-app)  **跨平台 📱** | 2.31.1 | 抓包工具，Android小黄鸟作者 |
| [WiresharkPortable](https://www.wireshark.org/download.html) **跨平台** |     4.4.3     | 抓包工具             |
...
| [Burp Suite](https://portswigger.net/burp/releases)  [汉化](https://github.com/Leon406/BurpSuiteCN-Release) **跨平台** | 2024.11.2 | 渗透 2023.1.2/2023.2.2版本开始不支持win10以下 |
|                                                              |           |                                               |
...
| 软件                                                         |  版本  | 说明        |
| ------------------------------------------------------------ | :----: | ------------- |
| [Telegram](https://github.com/telegramdesktop/tdesktop/releases)  🔄 **跨平台** | 5.10.4 | 聊天          |
...
| [v2rayN](https://github.com/2dust/v2rayN/releases) github<br>[v2ray-core](https://github.com/v2fly/v2ray-core/releases) github |  7.6.1<br>5.24.0  | v2ray ss工具<br>v2ray core |
...
| 软件                                                         |  版本   | 说明                                |
| ------------------------------------------------------------ | :-----: | ------------------------------------- |
| [MobaXterm](https://mobaxterm.mobatek.net/download-home-edition.html) |  24.4  | 终端工具                              |
...
| [escrcpy](https://github.com/viarotel-org/escrcpy) 更新快<br/>[QtScrcpy](https://github.com/barry-ran/QtScrcpy/releases/latest) github  <br>[scrcpy](https://github.com/Genymobile/scrcpy) **跨平台** |  1.28.3<br/>3.1.0<br>3.1  | Android 投屏电脑                      |
...
| [VSCode](https://github.com/microsoft/vscode/releases/latest) github | 1.96.3 | 编辑器                                |
| [Notepad++](https://notepad-plus-plus.org/downloads/)  [github](https://github.com/notepad-plus-plus/notepad-plus-plus/releases/latest) | 8.7.5 | 文本编辑 |
| [EmEditor ](https://www.emeditor.com/download/) | 24.5.3 | 编辑器 支持大文件 |
| [ApiFox](https://www.apifox.cn/help/app/changelog/)  [在线版](https://www.apifox.cn/web) **跨平台** :star: | 2.6.41 | 接口测试 |
| [ApiPost](https://www.apipost.cn/download.html) [在线版](https://console.apipost.cn/apis/project) **跨平台** |  8.1.9  | 接口测试                              |
| [GithubDesktop](https://desktop.github.com/release-notes/)  [汉化](https://pan.lanzoub.com/b06mtfjkh) |  3.4.12  | github 桌面端                         |
...
| [Recaf](https://github.com/Col-E/Recaf)<br>  [jclasslib](https://github.com/ingokegel/jclasslib)   **跨平台** | 2.21.4<br>6.1 | jar修改工具 |
...
| 软件                                                         |          版本          | 说明          |
| ------------------------------------------------------------ | :--------------------: | --------------- |
| [FastStoneCapure](http://www.faststone.org/)                 |          10.9          | 截图编辑工具    |
| [XnView MP](https://www.xnview.com/en/xnviewmp/)  **跨平台**    |         1.8.3         | 图片查看        |
| [ToDesk](https://www.todesk.com/download.html)  **跨平台**      | 4.7.6.0 | 远程控制 速度快 |
...
| [edge ](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      131.0.2903.146      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      132.0.6834.83      | 浏览器          |
...
| [Text-Grab](https://github.com/TheJoeFin/Text-Grab/releases) github | 4.7.0 | OCR powertoy内置 |
...
| [Qalcualte](https://github.com/Qalculate/qalculate-gtk/releases) github | 5.4 | 科学计算器 |
| [NETworkManager](https://github.com/BornToBeRoot/NETworkManager/releases) github |  2024.12.20.0  | 网络工具 |
|  |  |  |
...
| 软件                                                  |    版本    | 说明       |
| ----------------------------------------------------- | :--------: | ---------- |
| [R-Studio Network](https://www.lanzoub.com/b06lrnsfg) | 9.3.191420 | 文件恢复   |
| [AIDA](https://www.lanzoub.com/b06lweyad)             | 7.50.7200  | 系统检测   |
| [ventoy](https://github.com/ventoy/Ventoy/releases)   |   1.0.99   | 系统启动盘 |
|                                                       |            |            |
...
| 软件                                                         |   版本   | 说明                 |
| ------------------------------------------------------------ | :------: | -------------------- |
| [xnconvert](https://www.xnview.com/en/xnconvert/#downloads)  | 1.102.0  | 图片格式转换汉化工具 |
...
| 软件                                                         |  版本   | 说明                              |
| ------------------------------------------------------------ | :-----: | --------------------------------- |
| [音乐助手github](https://github.com/lyswhut/lx-music-desktop)  [beta](https://github.com/lyswhut/lx-music-desktop/actions/workflows/beta-pack.yml) <br> [6音音源 8mno](https://www.lanzoub.com/b00p9c94f?pwd=8mno)  [洛雪音源](https://github.com/lyswhut/lx-music-source/tree/master/dist) **跨平台** |  2.9.0  | 音乐助手                          |
...
| [Golden Dict ng](https://github.com/xiaoyifang/goldendict-ng) **跨平台** | 24.09.1 | 词典翻译                          |
...
| [FontViewOk](http://www.softwareok.com/?seite=Freeware/FontViewOK/Autoupdate) |  8.55   | 字体预览                          |
| [softCnKiller](https://www.lanzoub.com/b0cpu1guf)            |  2.82   | 流氓软件检测                      |
| [直播Simple Live](https://github.com/xiaoyaocz/dart_simple_live/releases)  **跨平台** |         | 斗鱼、虎牙、b站、抖音直播平台聚合 |
...
| ------------------------------------------------------------ | :---------------------------------------------: | ----------------------------------------- |
| [.NET8 (LTS 2026/11)](https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0) <br>[.NET6 (LTS 2024/11)](https://dotnet.microsoft.com/zh-cn/download/dotnet/6.0) |                8.0.11<br/>6.0.36                |                                           |
| [java](https://www.oracle.com/java/technologies/downloads/#java17)<br>[旧版归档](https://www.oracle.com/java/technologies/downloads/archive/)<br/> |    8u431<br/>11.0.25<br/>17.0.13<br/>21.0.5     | [whichjdk.com](https://whichjdk.com/)     |
