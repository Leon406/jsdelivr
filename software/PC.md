...
| [ChatAll](https://github.com/sunner/ChatALL/releases/latest)  github**跨平台** |  1.82.108   | 需要自有账号                                                 |
...
| [eSearch](https://github.com/xushengfeng/eSearch/releases/latest) **跨平台** github |   14.1.0    | 屏幕搜索功能，当然也是一款方便的截屏软件                     |
...
| 软件                                                         |      版本      | 说明               |
| ------------------------------------------------------------ | :------------: | -------------------- |
| [jadx-gui](https://github.com/skylot/jadx/releases)   github **跨平台** |     1.5.0     | Android反编译        |
...
| [WiresharkPortable](https://www.wireshark.org/download.html) **跨平台** |     4.4.0     | 抓包工具             |
...
| [v2ray](https://github.com/v2fly/v2ray-core/releases) github | 5.21.0 | v2ray工具     |
...
| [ApiFox](https://www.apifox.cn/help/app/changelog/)  [在线版](https://www.apifox.cn/web) **跨平台** :star: | 2.6.25 | 接口测试 |
| [ApiPost](https://www.apipost.cn/download.html) [在线版](https://console.apipost.cn/apis/project) **跨平台** |  8.1.4  | 接口测试                              |
...
| [edge ](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      130.0.2849.46      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      130.0.6723.59      | 浏览器          |
...
| [FontViewOk](http://www.softwareok.com/?seite=Freeware/FontViewOK/Autoupdate) |   8.51   | 字体预览       |
...
| [nodejs](https://nodejs.org/en)                              |                   20.18.0 LTS                   |                                           |
