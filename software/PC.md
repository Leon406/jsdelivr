...
| 软件                                                         |    版本     | 说明                        |
| ------------------------------------------------------------ | :---------: | --------------------------- |
| [FastGestures](https://fg.zhaokeli.com/#doc) [github](https://github.com/zhaokeli/FastGestures) |    2.2.9    | 全局鼠标手势,仅windows      |
...
| [chatall](https://github.com/sunner/ChatALL/releases/latest)  github**跨平台** |  1.71.100   | 需要自有账号                |
...
| [Burp Suite](https://portswigger.net/burp/releases)  [汉化](https://github.com/Leon406/BurpSuiteCN-Release) **跨平台** | 2024.3.1.1 | 渗透 2023.1.2/2023.2.2版本开始不支持win10以下 |
|                                                              |            |                                               |
...
| 软件                                                         |  版本  | 说明        |
| ------------------------------------------------------------ | :----: | ------------- |
| [Telegram](https://github.com/telegramdesktop/tdesktop/releases)  自动更新 **跨平台** | 4.16.6 | 聊天          |
...
| [XnView MP](https://www.xnview.com/en/xnviewmp/)  **跨平台**    |         1.7.1         | 图片查看        |
...
| [edge ](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      123.0.2420.97      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      122.0.6261.156      | 浏览器          |
...
| 软件                                                         |   版本   | 说明           |
| ------------------------------------------------------------ | :------: | -------------- |
| [音乐助手github](https://github.com/lyswhut/lx-music-desktop)  [beta](https://github.com/lyswhut/lx-music-desktop/actions/workflows/beta-pack.yml) [无损音源 8mno](https://www.lanzoub.com/b00p9c94f?pwd=8mno) **跨平台** |  2.7.0   | 音乐助手       |
...
| [FontViewOk](http://www.softwareok.com/?seite=Freeware/FontViewOK/Autoupdate) |   8.41   | 字体预览       |
...
| ------------------------------------------------------------ | :----------------------------------------------: | ----------------------------------------- |
| [.NET6 (LTS)](https://dotnet.microsoft.com/zh-cn/download/dotnet/6.0) <br>[.NET8 (LTS)](https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0) |                 6.0.29<br/>8.0.4                 |                                           |
...
| [nodejs](https://nodejs.org/en)                              |                   20.12.2 LTS                    |                                           |
