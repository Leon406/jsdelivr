...
| [CopyQ](https://github.com/hluk/CopyQ/releases/latest) ![github](icon/github.png) **跨平台** |   10.0.0    | 剪切板管理工具                                               |
| [cmder![github](icon/github.png)](https://github.com/cmderdev/cmder/releases)  [ConEmu![github](icon/github.png)](https://github.com/Maximus5/ConEmu) [clink![github](icon/github.png)](https://github.com/chrisant996/clink/releases) |   1.3.25    |                                                              |
...
| 软件                                                         |      版本      | 说明               |
| ------------------------------------------------------------ | :------------: | -------------------- |
| [jadx-gui](https://github.com/skylot/jadx/releases)   ![github](icon/github.png) **跨平台** |     1.5.2     | Android反编译        |
| AndroidKiller | 1.3.1 | Android反编译 |
| [010Editor](https://www.sweetscape.com/010editor/) | 15.0.2 | 二进制查看编辑 |
| [WinHex](http://www.x-ways.net/winhex/) [crack](https://pan.lanzoub.com/b0f1bltdg) |      21.4      | 二进制查看编辑       |
| [Sqlitebowser ![github](icon/github.png)](https://github.com/sqlitebrowser/sqlitebrowser/releases) |     3.13.1     | Sqlite数据库查看     |
| [dnSpyEx![github](icon/github.png)](https://github.com/dnSpyEx/dnSpy)  [ci](https://github.com/dnSpyEx/dnSpy/actions/workflows/build.yml) |     6.5.1     | .Net 逆向工具        |
| [Fiddler](https://www.telerik.com/fiddler) [汉化](https://github.com/gabrielxvx/zh-fiddler) | 5.0.20202.1817 | 抓包工具(http/https) |
| [reqable![github](icon/github.png)](https://github.com/reqable/reqable-app) **跨平台 📱** | 2.33.12 | 抓包工具，Android小黄鸟作者 |
| [WiresharkPortable](https://www.wireshark.org/download.html) **跨平台** |     4.4.7     | 抓包工具             |
...
| 软件                                                         |  版本   | 说明                                |
| ------------------------------------------------------------ | :-----: | ------------------------------------- |
| [MobaXterm](https://mobaxterm.mobatek.net/download-home-edition.html) [汉化](https://github.com/Eilte/Mobaxterm-Chinese) |  25.2  | 终端工具                              |
...
| [edge](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-relnote-stable-channel)  [下载](https://www.microsoft.com/zh-cn/edge/business/download?ch&form=MA13FJ)  **跨平台** |      137.0.3296.62      | 浏览器          |
| [Chrome ](https://chromiumdash.appspot.com/releases?platform=Windows)  **跨平台** |      137.0.7151.69      | 浏览器          |
...
| [Golden Dict ng](https://github.com/xiaoyifang/goldendict-ng) **跨平台** | 25.06.0 | 词典翻译                          |
